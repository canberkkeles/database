...
<head>
    ...
    <title>Admin Panel Supplier</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <h3 class='display-4' align = 'center'>Edit Suppliers</h3> <hr>
  <table class="table">
  <thead>
    <tr>
      <th scope="col">Supplier ID</th>
      <th scope="col">Supplier Brand Name</th>
  ...
  <?php
                ...
                $check = mysqli_query($link,"SELECT * FROM supplier ");
                ...
                {
                    $id = $myarr[$i]["supplierid"];
                    $name = $myarr[$i]["supplierbrandname"];

                    echo "<tr>";
                    echo "<th scope = 'row'>" .$id."</th>";
                    echo "<td>".$name."</td>";
                    echo "<td><a class='btn btn-success' href='editsupplier.php?ID={$id}' role='button'>Edit</a></td>";
                    echo "<td><a class='btn btn-danger' href='deletesupplier.php?ID={$id}' role='button'>Delete</a></td>";
                    echo "</tr>";
                }
            ?>
  </tbody>
...
<br>
<a class="btn btn-primary" href = 'addsupplier.php' role = 'button'>Add New Supplier</a>
