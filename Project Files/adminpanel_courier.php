...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <h3 class='display-4' align = 'center'>Edit Couriers</h3> <hr>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Associated Store</th>
  ...
  <?php
                ...
                $check = mysqli_query($link,"SELECT * FROM courier ");
                ...
                for($i = 0 ; $i < $row_number ; $i++)
                {
                    ...
                    $check = mysqli_query($link,"SELECT * FROM courier C,store S WHERE C.CourierID = '$id' AND C.storeid = S.storeid LIMIT 1");
                    ...
                    echo "<td>".$vehicle."</td>";
                    echo "<td>".$sname. "</td>";
                    echo "<td><a class='btn btn-success' href='editcourier.php?ID={$id}' role='button'>Edit</a></td>";
                    echo "<td><a class='btn btn-danger' href='deletecourier.php?ID={$id}' role='button'>Delete</a></td>";
                    echo "</tr>";
                }
            ?>
  </tbody>
...
<br>
<a class="btn btn-primary" href = 'addcourier.php' role = 'button'>Add New Courier</a>
</body>
</html>