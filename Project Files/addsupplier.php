...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <form method = "POST" action="addsupplierfinal.php">
  <div class="form-group">
          <label for="managerid">Supplier ID</label>
          <input type="number" class="form-control" id="supplierid" name = "id" placeholder="ID of the Supplier">
        </div>
      <div class="form-group">
          <label for="managername">Supplier Name</label>
          <input type="text" class="form-control" id="suppliername" name = "name" placeholder="Name of the Supplier">
        </div>
        <br><br>
