...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <h3 class='display-4' align = 'center'>Edit Managers</h3> <hr>
  ...
  <?php
                ...
                $check = mysqli_query($link,"SELECT * FROM manager ");
                ...
                {
                    $id = $myarr[$i]["managerid"];
                    $name = $myarr[$i]["managername"];

                    $check = mysqli_query($link,"SELECT * FROM manages M,store S WHERE M.managerid = '$id' AND M.storeid = S.storeid LIMIT 1");
                    ...
                    echo "<td>".$name."</td>";
                    echo "<td>".$sname. "</td>";
                    echo "<td><a class='btn btn-success' href='editmanager.php?ID={$id}' role='button'>Edit</a></td>";
                    echo "<td><a class='btn btn-danger' href='deletemanager.php?ID={$id}' role='button'>Delete</a></td>";
                    echo "</tr>";
                }
            ?>
  </tbody>
...
<br>
<a class="btn btn-primary" href = 'addmanager.php' role = 'button'>Add New Manager</a>
</body>
</html>