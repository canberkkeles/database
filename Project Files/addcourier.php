...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <form method = "POST" action="addcourierfinal.php">
  <div class="form-group">
          <label for="courierid">Courier ID</label>
          <input type="number" class="form-control" id="courierid" name = "id" placeholder="ID of the courier">
        </div>
      <div class="form-group">
          <label for="couriername">Courier Name</label>
          <input type="text" class="form-control" id="couriername" name = "name" placeholder="Name Surname">
        </div>
        <div class="form-group">
          <label for="couriervehicle">Courier Vehicle</label>
          <input type="text" class="form-control" id="couriervehicle" name = "vehicle" placeholder="(Car,Motorcycle etc.)">
        </div>
        ...
        <?php
           ...
           if($row_number == 0){
            echo "<script>alert('There is no store to assign courier to');</script>";
